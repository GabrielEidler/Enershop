      ...
      const businessQuestions = () => {
        ...
        const button_business_5 = () => {
            ...
            if ( Number(cost) !== 0 ) 
            {
              ...
              return JSON.stringify(userNegocio);
        ...
        $('.business-address_plus-button').click(()=>{
          ...
          if($('.business-address_tag').length === 1 ){
            $('.business-address_tag').text(address);
          }else{

            let createdTag = $('<div class="business-address_tag"><div class="business_address-tag_title">placeholder</div> <img class="business_address-tag_icon" loading="lazy" src="https://uploads-ssl.webflow.com/623a277a8114641bbe232243/62854c1d96afa41e4454ae73_close-button.svg" ></img> </div>').appendTo('.business_address-tag_wrapper');
        ...
        $('input[type=radio][name=business-form]').change(function() {
            voltage = $(
            "input[name=business-form]:checked",
            ".business-form"
            ).val();
        });
